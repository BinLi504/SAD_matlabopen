% The folder "SADdemo\Samples" contains the codes for the SAD algorithms
% "MainSADleastbatch.m" is the method using the least square method to process
% multiple speech signals.
% 
% %
% Written by Bin Li, moderated by Wenwu Wang, version 1.0                                    
%
...
% w.wang@surrey.ac.uk
%     
% Copyright 2020 Copyright 2020 B. Li, L. Rencker, J. Dong, Y. Luo, M.D. Plumbley, W. Wang
% 
