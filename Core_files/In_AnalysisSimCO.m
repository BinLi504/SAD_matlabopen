function [Omega, f_itn] = In_AnalysisSimCO(Y, param)
% This function implements the Incoherent Analysis SimCO algorithm 
% @ October 2014, University of Surrey
%
...
for it=1:itN
    ...
    %% decorrelation step, use functions from SMALL project
    dico = dico_decorr_symetric(Omega',mu);
    Omega = dico';
    
    % cost function
    f_itn(:, it)=norm(X_sparse-Omega*Y, 'fro')^2;
end
